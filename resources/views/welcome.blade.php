...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <section>
            <nav class="mb-5 py-3 navbar shadow navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid mydiv">
                  <a class="navbar-brand" href="http://127.0.0.1:8000"><h5>Spotlight <span>Store</span></h5></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a href="http://127.0.0.1:8000/auth/signin" class="nav-link"><i class=" fas fa-user"></i></a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 text-dark mb-lg-0">
                        <li class="nav-item text-dark">
                            <a href="http://127.0.0.1:8000/auth/signin" class="nav-link">Sign In</a>
                        </li>
                        <li class="nav-item mt-2">
                            <span>||</span>
                        </li>
                        <li class="nav-item text-dark">
                            <a href="http://127.0.0.1:8000/auth/signup" class="nav-link">Sign Up</a>
                        </li>
                      </ul>
                  </div>
                </div>
